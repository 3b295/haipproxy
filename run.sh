...
nohup python crawler_booter.py --usage validator init amazon > init_validator.log 2>&1 &
nohup python scheduler_booter.py --usage validator amazon > https_validator.log 2>&1&
